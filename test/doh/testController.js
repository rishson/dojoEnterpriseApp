...
doh.register("Controller tests", [
    {
        ...
        runTest: function(){
            ...
            doh.assertEquals(controller.handleResponse, controller.transport.handleResponseFunc);
            doh.assertEquals(controller.handleError, controller.transport.handleErrorFunc);
        },
        tearDown: function(){
        }
    },

define([
    ...
    return declare("rishson.control._Controller", [Base], {
		...
		/**
		 * @name rishson.control._Controller.getLayoutDomNode
		 * @description Return the controller's view layout domNode.
		 * @return {Object}
		 */
		getLayoutDomNode : function () {
			if ((this.views || {}).layout) {
				return this.views.layout.domNode;
			}
		}
    });
});